...
class THttpClient(TTransportBase):
    ...
    def __init__(self, uri_or_host, port=None, path=None, cafile=None, cert_file=None, key_file=None, ssl_context=None, custom_proxy=None):
        ...
        try:
            #proxy = "https://{}".format(random.choice(list_host))
            proxy = None
            if custom_proxy != None:
                proxy = "https://{}".format(custom_proxy)
            #print(proxy)
        except KeyError:
            proxy = None
        else:
    ...
    def basic_proxy_auth_header(proxy):
        ...
        cr2 = base64.b64encode(ap.encode("utf-8"))
        cr = str(cr2, "utf-8")
        return "Basic " + cr
