...
func NewTHttpClientWithOptions2(urlstr string, t *http.Transport, options THttpClientOptions) (TTransport, error) {
...
func NewTHttpClientWithOptions1(urlstr string, tr *http.Transport) (TTransport, error) {
	parsedURL, err := url.Parse(urlstr)
	if err != nil {
		return nil, err
	}
...
func NewTHttpClient(urlstr string, tr *http.Transport) (TTransport, error) {
	return NewTHttpClientWithOptions1(urlstr, tr)
}
...
func NewTHttpClientProxy(urlstr string, cl *http.Client) (TTransport, error) {
	return NewTHttpClientWithOptions(urlstr, THttpClientOptions{Client:cl})
}
